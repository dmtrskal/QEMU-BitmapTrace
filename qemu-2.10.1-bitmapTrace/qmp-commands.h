...
void qmp_bitmap_trace(bool state, const char *filename, bool has_iterations, int64_t iterations, bool has_period, int64_t period, Error **errp);
void qmp_marshal_bitmap_trace(QDict *args, QObject **ret, Error **errp);
