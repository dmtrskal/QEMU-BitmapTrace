...
ETEXI
    ...
    {
        .name       = "bitmap-trace",
        .args_type  = "state:b,filename:s,iterations:i?,period:i?",
        .params     = "state filename iterations period",
        .help       = "Enable/Disable the bitmap tracking mechanism"
        ...
        .cmd        = hmp_bitmap_trace,
    },

STEXI
@item bitmap-trace @var{state} @var{filename} @var{iterations} @var{period}
@findex bitmap-trace
Enable/Disable the bitmap tracking mechanism
ETEXI
